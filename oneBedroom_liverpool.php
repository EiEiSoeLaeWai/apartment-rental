...
<?php
         ...
         $sql ="SELECT * FROM apartments where bedroom=1 and city_id=4";
...
<?php }?>
  ...
  <div class="card-header">Currently available to rent in Liverpool</div>
  <div class="card-body">
    <h5 class="card-title">All houses to rent in Liverpool</h5>
    <a href="oneBedroom_liverpool.php"><p class="card-text"> 1 Bed Flat to rent <br></a>
    <a href="twoBedroom_liverpool.php">              2 Bedroom Flat to rent </a>
