...
<?php
         ...
         $sql ="SELECT * FROM apartments where bedroom=1 and city_id=1";
...
<?php }?>
  ...
  <div class="card-header">Currently available to rent in London</div>
  <div class="card-body">
    <h5 class="card-title">All houses to rent in London</h5>
    <a href="oneBedroom_london.php"><p class="card-text"> 1 Bed Flat to rent <br></a>
    <a href="twoBedroom_london.php">              2 Bedroom Flat to rent </a>
