...
<?php
         ...
         $sql ="SELECT * FROM apartments where bedroom=2 and city_id=5";
...
<?php }?>
  ...
  <div class="card-header">Currently available to rent in Manchester</div>
  <div class="card-body">
    <h5 class="card-title">All houses to rent in Manchester</h5>
    <a href="oneBedroom_manchester.php"><p class="card-text"> 1 Bed Flat to rent <br></a>
    <a href="twoBedroom_manchester.php">              2 Bedroom Flat to rent </a>
